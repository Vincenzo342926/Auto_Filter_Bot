...
PICS_URL = (environ.get('PICS', 'https://files.catbox.moe/bvmx42.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
PICS = (environ.get('PICS', 'https://files.catbox.moe/bvmx42.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://files.catbox.moe/bvmx42.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/rxswp9.jpg'))
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7189366263').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1004486355064').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003954369699'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1004389489591'))  # Bin channel id (make sure bot is admin)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003771029643')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-100')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/knox_support12')  # Support group link (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/68c9b4fe511ea9fb8cd4d-a66ef18257d0e1c67f.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'bajajpay.6879729.cu48106117@indus')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://muttalibkhan75_db_user:SVGkZjWJEw530Bmc@cluster0.fhcsd4l.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/kdrama_dekhoo")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/kdrama_dekhoo")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/kdrama_dekhoo")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "fa8b07cfd05b65f2eff841efd25a4e135750bfa9") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "arolinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "fa8b07cfd05b65f2eff841efd25a4e135750bfa9")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "arolinks.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "fa8b07cfd05b65f2eff841efd25a4e135750bfa9")
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/knox_search') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ProudJorukagulaam') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/knox_search') # Update channel link for the bot
...
PREMIUM_STREAM_MODE = is_enabled(environ.get('PREMIUM_STREAM_MODE', "False"), True) # Set Stream mode True or False only for premium users
